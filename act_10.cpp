...
const int MAX_SIZE = 15; // Tamaño máximo de la matriz
...
int main() {
    ...
    if (option == 'S' || option == 's') {
        ...
        llenarMatrixAleatorio(matrixB, size, time(0) + 1); // Usamos la hora actual más 1 segundo como semilla para matriz B
